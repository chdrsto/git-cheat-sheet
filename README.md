...
## Stage, Commit and Push local changes to the github repositiry

```bash
$ cd to the root folder of the local git repository
$ git add --all # stage the changes (eg. all changes)
$ git commit -m "Description of local changes made ..." # Comment all changes made related to the push
$ git push
```
